  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <ol className="mt-8 space-y-3">
        {STEPS.map((s) => (
          <li key={s.n} className="flex gap-4 rounded-lg border border-border bg-surface p-4">
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-bg font-mono text-sm text-muted">{s.n}</span>
            <div>
