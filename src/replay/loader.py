...
from src.models import Conversation, Persona, PersonaType, Turn
...
from src.replay.parsers import detect_format, get_parser
...
class ConversationLoader:
    ...
    def _score_quality(
        ...
        """
        from src.replay.models import ConversationQuality
